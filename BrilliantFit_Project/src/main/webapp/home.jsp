              ...
              <div class="food-items" > 
                ...
                <div class="deails">
                    <div class="details-sub">
                        ...
                        <form name="f" id="myForm" action="home.jsp">
                           &nbsp;&nbsp;&nbsp; <input type="text" name="calorie" value="<%= cal %>" disabled id="cal">Cal/100g
                           
                            <input type="hidden" name="cal" value="<%=cal%>">
                    </div>
                        
                       &nbsp; <p>Qty:</p><input type="number" name="qty" class="price1"  min="1" value="1"> <span id="total"></span><br>
    ...
    if (calorieParam != null && qtyParam != null) {
        try {
            ...
            if (index < arr.length) {
                ...
                %> <script> alert("<%= arr[index] %> calories have been added!!!")
