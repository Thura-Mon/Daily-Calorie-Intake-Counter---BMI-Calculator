...
<body>
    ...
    <form action="ProductUploadServlet" method="post" enctype="multipart/form-data">
        ...
        <input type="text" class="input_iud" id="cid" name="cid" required><br><br>
        
        <label for="name">Product Name:</label>
        <input type="text" class="input_iud id="name" name="name" required><br><br>
        
        <label for="calorie">Product Calorie</label>
        <input type="text" class="input_iud id="calorie" name="calorie" required><br><br>
        
        <label for="image">Product Image:</label>
        <input type="file"  id="image" name="image" accept="image/*" required><br><br>
        
        <input type="submit" class ="iud" value="Upload Product"> &nbsp; <a href="admin_upload.jsp"><input type="button" class="iud" value="Cancel"></a>
    </form>
