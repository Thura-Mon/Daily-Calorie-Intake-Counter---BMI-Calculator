...
<body>
    <div class="header">
        <div id="main-content">
           ...
           <p style="color: darkgreen; padding-right: 50%; margin-top: 15px; font-size:30px;">Brilliant Fit</p>
        ...
        <div class="menu">
            <%
                ...
                try {
                    ...
                    String getsql = "SELECT * FROM product WHERE cid='c2'";
              ...
              <div class="food-items" > 
                ...
                <div class="deails">
                    <div class="details-sub">
                        ...
                        <form name="f" id="myForm" action="fruit.jsp">
