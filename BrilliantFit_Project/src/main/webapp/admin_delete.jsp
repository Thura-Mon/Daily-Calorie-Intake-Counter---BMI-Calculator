...
<label for="name">Performing deletion of all information related to a single product:</label><br><br>
        <input type="text" id="name" name="name" class="input_iud" required> <br><br><br>
        <input type="submit" class="iud" value="Delete Product"> &nbsp; <a href="admin_upload.jsp"><input type="button" class="iud" value="Cancel"></a>
</form>
  </div>
