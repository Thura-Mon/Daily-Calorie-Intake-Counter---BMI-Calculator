    ...
    <div class="header">
        ...
        <div class="menu">
         ...
         <%      try {
          ...
          String getsql = "select * from product where cid='c1'";
            ...
            <div class="food-items" > 
                ...
                <div class="deails">
                    <div class="details-sub">
                        ...
                        <form name="f" id="myForm" action="meal.jsp">
    ...
    <div id="sidebar">
        <div class="sidebarHeader">
            <div><img src="blf_logo.jpg" class="INteamlogo"></div>
                <div><button class="close-btn" onclick="toggleSidebar()" ><img src="cross.jpg" class="cross">
            </button></div>
        </div>
        <div class="line"></div>
        <a href="home.jsp">
