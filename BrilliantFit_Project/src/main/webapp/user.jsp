...
<body>
    ...
    <div class="header">
        ...
        <div class="content">
                       <h2 class="product">User Information</h2>
               <table>
               <thead>
                       <th> </th>
                   <th>Email</th>
                  ...
                  <th><select name="s1" id="s" class="select" onchange="window.location.href=this.value;">                   
                    ...
                    <option value="delete_user.jsp" class="delete">Delete User</option>
                    </select></th>
          ...
          PreparedStatement ast = con.prepareStatement(getsql);
           ...
           while (get.next()) {
        	   String uemail = get.getString("user_email");
        	   String uname = get.getString("user_name");
        	   String upass = get.getString("user_password");
        	    %>
