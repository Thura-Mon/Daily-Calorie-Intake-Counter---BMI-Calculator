...
<h1>Update Category</h1>
    <form action="update_category" method="post">
        ...
        <label for="old-cname">Old Category Name</label>
		<input type="text" id="old-cname" class="input_iud" name="old-cname" ><br><br>

		<label for="cname">New Category Name</label>
		<input type="text" id="cname" class="input_iud" name="cname" ><br><br>
        
        
        
        <input type="submit" class="iud" value="Change Category"> &nbsp; <a href="upload_category.jsp"><input type="button" class="iud" value="Cancel"></a>
