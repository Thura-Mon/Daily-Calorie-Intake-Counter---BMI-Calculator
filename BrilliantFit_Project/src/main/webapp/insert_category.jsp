...
<h1>Upload Category</h1>
    <form action="CategoryUploadServlet" method="post" >
        <label for="cid">Category ID:</label>
        <input type="text" id="cid" name="cid" required><br><br>
        
        <label for="name">Category Name:</label>
        <input type="text" id="name" name="name" required><br><br>
        <input type="submit" class="iud" value="Upload Category"> &nbsp; <a href="upload_category.jsp"><input type="button" class="iud" value="Cancel"></a>
    </form>
          </div>
