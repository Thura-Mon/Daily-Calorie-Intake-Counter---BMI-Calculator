...
<div class="header">
 ...
 <h1>Update Product</h1>
    <form action="admin_update" method="post" enctype="multipart/form-data">
        <label for="cid">New Category ID:</label>
        <input type="text" id="cid" class="input_iud" name="cid" required><br><br>
        
        <label for="calorie">New Product Calorie</label>
        <input type="text" id="calorie" class="input_iud" name="calorie" ><br><br>
        
        <label for="image">New Product Image:</label>
        <input type="file" id="image" class="" name="image" accept="image/*" ><br><br>
        
         <label for="name">Performing an update according to Product Name:</label>
        <input type="text" id="name" class="input_iud" name="name"><br><br>
        
         <input type="submit" class="iud" value="Update Product"> &nbsp; <a href="admin_upload.jsp"><input type="button" class="iud" value="Cancel"></a>
